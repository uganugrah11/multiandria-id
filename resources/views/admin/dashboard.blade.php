<x-layouts.admin title="Dashboard">
    ...
    <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div class="rounded-xl border border-mai-border bg-white p-6">
            <p class="text-xs font-semibold uppercase tracking-wide text-mai-slate">Portofolio Aktif</p>
            <p class="mt-2 text-3xl font-extrabold text-mai-charcoal">{{ $stats['active_portfolio'] }}</p>
        </div>
    </div>
